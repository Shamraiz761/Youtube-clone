import { ArrowDownward, Home, Subscriptions, ThumbUp, TrendingDown, VideoLibrary, VideoLibrarySharp, WatchLater } from '@material-ui/icons';
    ...
    <div className="text-gray-800 bg-white w-64 flex flex-col h-screen">
      ...
      <div className="flex-grow">
        <ul className="space-y-4">
          ...
          <li className="p-4 hover:bg-gray-700 cursor-pointer flex items-center">
           <HoLibrarme className='mr-3'/> Library
          </li>
          <li className="p-4 hover:bg-gray-700 cursor-pointer flex items-center">
           <History /> History
          </li>
