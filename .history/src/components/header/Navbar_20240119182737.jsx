      ...
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <div className="flex items-center">
          <input
            type="text"
            placeholder="Search"
            className="px-4 py-2 rounded-l-md border border-gray-100 focus:outline-none w-20 md:w-96"
          />
          <button className="bg-gray-400 px-1  md:px-4 md:py-2 rounded-r-md text-white">
            <SearchIcon />
          </button>
        </div>
