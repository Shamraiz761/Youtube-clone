...
const Sidebar = () => {
  ...
  return (
    <div className="text-gray-800 bg-white w-48 fixed z-50 flex flex-col h-[89vh]">
        ...
        <ul className="space-y-2 overflow-auto ">
            {
                data.map((item) => (
                        ...
                        <li className={`pl-8 py-3 hover:bg-gray-200 hover:text-red-600 cursor-pointer flex items-center text-sm font-medium `}>
